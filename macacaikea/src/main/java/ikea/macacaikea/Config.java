...
public class Config {
	...
	// 根目录
	public static final String ROOT_PATH = ".\\Log";//System.getProperty("user.dir");
	//".\\Log" + "\\" + OutputFileName + ".log";
	// 截图保存目录
	...
	public static final String IOS_APP = ROOT_PATH + File.separator + "app/ios-app-bootstrap.zip";
